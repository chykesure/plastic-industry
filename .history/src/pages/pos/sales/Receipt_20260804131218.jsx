...
@media print {
  ...
  // Builds logo <img> with absolute URL for print windows
  const getLogoHtml = (size = 90) => {
            ...
            <div className="p-10 md:p-12" ref={receiptRef}>
              ...
              <div className="text-center mb-10">
                <img
                  ...
                  style={{ width: 190, height: 190, objectFit: "contain", display: "block", margin: "0 auto 10px auto" }}
                />
