...
@media print {
  ...
  * { box-sizing: border-box; }
  ...
  const getLogoHtml = (size = 110) => {
    const fullUrl = window.location.origin + LOGO_PATH;
    return `<img src="${fullUrl}" alt="Company Logo" style="display:block; width:${size}px; height:${size}px; object-fit:contain; flex-shrink:0;" />`;
  };

  // Watermark HTML for print windows — uses ABSOLUTE URL, z-index 9999
  ...
  const handlePrintWaybill = () => {
    ...
    const waybillHeader = `
<div class="company-header-row" style="display:flex; align-items:center; gap:20px; margin-bottom:6px; position:relative; z-index:1;">
  ${getLogoHtml(110)}
  <div>
    ...
    <div style="font-size:11px; color:#333; line-height:1.6; text-align:left;">
...
<div style="position:relative; z-index:1;">
  <hr style="border:none; border-top:2.5px solid #0d1b2a; width:100%; margin:0 0 10px 0;" />
  <div style="font-family:'Inter',Arial,sans-serif; font-size:10px; font-weight:700; letter-spacing:4px; text-transform:uppercase; color:#666; margin:0 0 16px 0; text-align:center;">
      ...
      <header className="bg-slate-800 border-b border-slate-700 shadow-lg sticky top-0 z-10 no-print">
        <div className="max-w-5xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="text-xl font-bold text-indigo-400">EO Komolafe</div>
        ...
        {sale && (
          <div className="bg-white text-gray-900 rounded-xl shadow-2xl overflow-hidden ring-1 ring-gray-200 border border-gray-200" style={{ position: "relative" }}>
            <div className="p-8 md:p-10" ref={receiptRef} style={{ position: "relative", overflow: "hidden" }}>
              ...
              {/* ── Watermark (in front, z-index 9999) ── */}
              <img
              ...
              <div className="company-header-row" style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: 20, marginBottom: 6 }}>
                <img
                  src={LOGO_PATH}
                  alt="Company Logo"
                ...
                <div>
                  ...
                  <div className="company-info" style={{ textAlign: "left", marginBottom: 0 }}>
                    Off Oshogbo Road, Behind Testing Ground, Ilesa, Osun State<br />
