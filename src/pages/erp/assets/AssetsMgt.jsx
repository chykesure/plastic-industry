...
function AssetsMgt() {
    ...
    useEffect(() => {
        if (!subpage) {
            navigate("/erp/assets/list", { replace: true });
        }
    }, [subpage, navigate]);

    const activeTab = subpage || "list";

    const handleTabChange = (tab) => {
        navigate(`/erp/assets/${tab}`);
    };
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-4 w-full">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-gray-400 mt-1">
                                Manage assets registration, depreciation, and maintenance efficiently.
                            </p>
                        </div>
                        ...
                        <div className="mb-6 border-b border-gray-700">
                            <nav className="flex space-x-8 -mb-px">
                                {["list", "depreciation", "maintenance"].map((tab) => (
                                    <button
                                        key={tab}
